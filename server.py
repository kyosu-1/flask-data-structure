...
from data_structure import linked_list, hash_table, binary_search_tree, stack, custom_q
...
def create_user():
    try:
        ...
        return jsonify({'message': f'[{e}]{traceback.format_exc()}'}), 500
...
def get_one_user(user_id):
    try:
        ...
        user = all_users_ll.get_user_by_id(int(user_id))
